...
public class SwaggerConfig {
	...
	private static Contact contact() {
		return new Contact("Lucas Lauro", "https://github.com/llauros/PersonalBlog_project",
				"lucaslauro@live.com");
	}
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder().title("API - Blog Pessoal").description("Projeto API Spring - Blog Pessoal")
				...
				.licenseUrl("https://github.com/llauros/PersonalBlog_project").contact(contact()).build();
	}
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.generation.myblog.controller"))
